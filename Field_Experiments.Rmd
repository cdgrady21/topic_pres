...
- Implementer priority is for a successful project, not to evaluate if the project was successful.
...
- Learn the language actively <!--With a little effort, can say every simple thing in local language within 1 month. -->
    - Be comfortable with no English unless people are speaking to you
...
- Don't ask others to do what you will now
- Be SUPER ORGANIZED


# Conclusion

- Field experiments are great opportunities for researchers
